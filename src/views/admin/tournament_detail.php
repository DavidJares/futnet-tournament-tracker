...
<div class="row g-3">
    <div class="col-12 col-xl-6">
        <div class="card shadow-sm">
            <div class="card-header bg-white">
                <button class="btn btn-link text-decoration-none p-0 fw-semibold" type="button" data-bs-toggle="collapse" data-bs-target="#settingsCollapse" aria-expanded="true" aria-controls="settingsCollapse">
                    Tournament settings
                </button>
            </div>
    ...
    <div class="col-12 col-xl-6">
        <div class="card shadow-sm mb-3">
            <div class="card-header bg-white">
                <button class="btn btn-link text-decoration-none p-0 fw-semibold" type="button" data-bs-toggle="collapse" data-bs-target="#assignmentCollapse" aria-expanded="true" aria-controls="assignmentCollapse">
                    Group assignment
                </button>
            </div>
            <div id="assignmentCollapse" class="collapse show">
                <div class="card-body">
        ...
        <div class="card shadow-sm mb-3">
            <div class="card-header bg-white">
                <button class="btn btn-link text-decoration-none p-0 fw-semibold" type="button" data-bs-toggle="collapse" data-bs-target="#addTeamCollapse" aria-expanded="true" aria-controls="addTeamCollapse">
                    Add team
                </button>
            </div>
        ...
        <div class="card shadow-sm">
            <div class="card-header bg-white">
                <button class="btn btn-link text-decoration-none p-0 fw-semibold" type="button" data-bs-toggle="collapse" data-bs-target="#existingTeamsCollapse" aria-expanded="false" aria-controls="existingTeamsCollapse">
                    Existing teams
                </button>
            </div>
            <div id="existingTeamsCollapse" class="collapse">
                <div class="card-body">
